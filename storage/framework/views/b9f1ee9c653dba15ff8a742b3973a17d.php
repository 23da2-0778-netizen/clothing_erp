...
<div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2 d-print-none">
    ...
    <div class="d-flex gap-2 flex-wrap">
        ...
        <button type="button" class="btn btn-primary" data-pdf-download data-pdf-target="#pdfContent" data-pdf-filename="daily-report-<?php echo e($date); ?>.pdf">
...
<div class="card border-0 shadow-sm mb-3 d-print-none">
    <div class="card-body">
        <form method="GET" action="<?php echo e(route('reports.daily')); ?>" class="row g-2 align-items-end">
            <div class="col-md-4">
...
<div class="row g-3 mb-3" >
    <div class="col-md-6">
        <div class="card border-0 shadow-sm">
            <div class="card-body">
                <p class="text-muted small mb-1">Total Sales — <?php echo e(\Carbon\Carbon::parse($date)->format('F d, Y')); ?></p>
            ...
            <table class="table table-hover mb-0 align-middle">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>Rs. <?php echo e(number_format($sale->unit_price, 2)); ?></td>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\MSI PC\Desktop\clothing-erp\clothing-erp\resources\views/reports/daily.blade.php ENDPATH**/ ?>