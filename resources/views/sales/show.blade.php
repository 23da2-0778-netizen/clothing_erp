...
<div class="d-flex align-items-center justify-content-between mb-4 flex-wrap gap-2 d-print-none">
    <a href="{{ route('sales.index') }}" class="btn btn-link text-decoration-none"><i class="bi bi-arrow-left"></i> Back to Sales</a>
    <div class="d-flex gap-2 flex-wrap">
        <button type="button" onclick="window.print()" class="btn btn-outline-primary"><i class="bi bi-printer"></i> Print</button>
        <button type="button" class="btn btn-primary" data-pdf-download data-pdf-target="#pdfContent" data-pdf-filename="bill-{{ $sale->sale_id }}.pdf">
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body p-4">
                ...
                <div class="d-flex justify-content-between border-bottom pb-2 mb-2">
                    ...
                    <strong>#{{ str_pad($sale->sale_id, 6, '0', STR_PAD_LEFT) }}</strong>
                </div>
                <div class="d-flex justify-content-between border-bottom pb-2 mb-2">
                    <span class="text-muted">Date</span>
                    <strong>{{ $sale->sale_date->format('F d, Y') }}</strong>
                </div>
                <div class="d-flex justify-content-between border-bottom pb-2 mb-2">
                ...
                <div class="d-flex justify-content-between border-bottom pb-2 mb-3">
                    ...
                    <strong>{{ $sale->cashier->name ?? 'N/A' }}</strong>
                </div>
                ...
                <table class="table table-borderless mb-3">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-end">Rs.{{ number_format($sale->unit_price, 2) }}</td>
                ...
                <div class="d-flex justify-content-between border-top pt-3">
                    <h5>Total</h5>
                    <h5>Rs.{{ number_format($sale->total_amount, 2) }}</h5>
                </div>
